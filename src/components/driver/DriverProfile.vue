...
const buyAkWhatsAppLink = computed(() => {
  ...
  const message = `Halo Admin, saya ${userName} (${phone}). Saya ingin top up Antur Kredit (AK). Saldo AK saya saat ini ${anturCreditBalance.value} AK. Mohon info metode pembayarannya.`
